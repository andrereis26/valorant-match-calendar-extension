...
/**
 * Everything this view needs from its host platform (extension popup,
 * PWA app shell, ...). No chrome.* or window.* calls happen directly
 * in this file.
 */
export interface MatchListPlatform {
...
export function mountMatchListView(platform: MatchListPlatform): void {
